...
<div id="right">
    ...
    <div id="r1" style="margin-top:10px;">
        ...
        <div id="rright">
            ...
            <a href="{{route('front/infor',array('id'=>$reS->goodsid))}}"><img src="{{asset('images/buy_btn.png')}}" /></a>
            <a href="{{route('front/addCollect',array('id'=>$reS->goodsid))}}">
                <img src="{{asset('images/collect_btn.png')}}" /></a>
